...
void xoaTaiViTri_Trieu_36_Bai_1_N2_B3(ds_Kep &k, int v) {
	...
	//Kiem tra co phai vi tri cuoi khong?
	else if (v == length_Trieu_36_Bai_1_N2_B3(k) - 1) {
...
int main () {
	...
	//Them Dau de ds la 6 10 5
	themDau_Trieu_36_Bai_1_N2_B3(k,5);
	themDau_Trieu_36_Bai_1_N2_B3(k, 10);
	themDau_Trieu_36_Bai_1_N2_B3(k, 6);
	//Them Cuoide ds la 6 10 5 88 77
	themCuoi_Trieu_36_Bai_1_N2_B3(k, 88);
	themCuoi_Trieu_36_Bai_1_N2_B3(k, 77);
	//Them 66 o phia sau 88 -> 6 10 5 88 66 77
	themSauPtu_Trieu_36_Bai_1_N2_B3(k, 88, 66);
	...
	//Xoa tai vi tri 1
	cout << "xoa ptu tai vi tri 1\n \n ========== " << endl;
	xoaTaiViTri_Trieu_36_Bai_1_N2_B3(k,0);
	output_Trieu_36_Bai_1_N2_B3(k);
